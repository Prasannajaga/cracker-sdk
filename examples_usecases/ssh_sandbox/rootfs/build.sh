...
IMAGE_NAME="cracker-sdk-ssh-sandbox-rootfs"
...
if ! grep -q '^ssh-' "${SCRIPT_DIR}/authorized_keys.example"; then
    echo "Add your SSH public key to rootfs/authorized_keys.example before building." >&2
    exit 1
fi
